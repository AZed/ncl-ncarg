...
C
C   $Id: cmf4kb.f,v 1.2 2006/11/21 01:10:16 haley Exp $
C
CCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCC

      SUBROUTINE DCMF4KB(LOT,IDO,L1,NA,CC,IM1,IN1,CH,IM2,IN2,WA)
      ...
      DOUBLE PRECISION CC(2,IN1,L1,IDO,4),CH(2,IN2,L1,4,IDO),WA(IDO,3,2)
C
