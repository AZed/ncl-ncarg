...
C
C   $Id: c1f4kf.f,v 1.2 2006/11/21 01:10:15 haley Exp $
C
CCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCC

      SUBROUTINE DC1F4KF(IDO,L1,NA,CC,IN1,CH,IN2,WA)
      DOUBLE PRECISION SN
      ...
      DOUBLE PRECISION CC(IN1,L1,IDO,4),CH(IN2,L1,4,IDO),WA(IDO,3,2)
C
