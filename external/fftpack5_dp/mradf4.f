...
C
C   $Id: mradf4.f,v 1.2 2006/11/21 01:10:18 haley Exp $
C
CCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCC

      SUBROUTINE DMRADF4(M,IDO,L1,CC,IM1,IN1,CH,IM2,IN2,WA1,WA2,WA3)
...
C
 ...
 1001     CONTINUE
  ...
  102 IDP2 = IDO + 2
      DO 104 K = 1,L1
          DO 103 I = 3,IDO,2
              ...
              DO 1003 M1 = 1,M1D,IM1
                  M2 = M2 + IM2
                  CH(M2,I-1,1,K) = ((WA1(I-2)*CC(M1,I-1,K,
     +                             2)+WA1(I-1)*CC(M1,I,K,2))+
     +                             (WA3(I-2)*CC(M1,I-1,K,
     +                             4)+WA3(I-1)*CC(M1,I,K,4))) +
     +                             (CC(M1,I-1,K,1)+ (WA2(I-2)*CC(M1,I-1,
     +                             K,3)+WA2(I-1)*CC(M1,I,K,3)))
     ...
     +                              (WA3(I-2)*CC(M1,I-1,K,
     +                              4)+WA3(I-1)*CC(M1,I,K,4)))
                  CH(M2,I,1,K) = ((WA1(I-2)*CC(M1,I,K,2)-WA1(I-1)*CC(M1,
     +                           I-1,K,2))+ (WA3(I-2)*CC(M1,I,K,
     +                           4)-WA3(I-1)*CC(M1,I-1,K,4))) +
     +                           (CC(M1,I,K,1)+ (WA2(I-2)*CC(M1,I,K,
     +                           3)-WA2(I-1)*CC(M1,I-1,K,3)))
                  CH(M2,IC,4,K) = ((WA1(I-2)*CC(M1,I,K,
     +                            2)-WA1(I-1)*CC(M1,I-1,K,2))+
     +                            (WA3(I-2)*CC(M1,I,K,4)-WA3(I-1)*CC(M1,
     +                            I-1,K,4))) - (CC(M1,I,K,1)+
     +                            (WA2(I-2)*CC(M1,I,K,3)-WA2(I-1)*CC(M1,
     +                            I-1,K,3)))
                  CH(M2,I-1,3,K) = ((WA1(I-2)*CC(M1,I,K,
     +                             2)-WA1(I-1)*CC(M1,I-1,K,2))-
     +                             (WA3(I-2)*CC(M1,I,K,
     +                             4)-WA3(I-1)*CC(M1,I-1,K,4))) +
     +                             (CC(M1,I-1,K,1)- (WA2(I-2)*CC(M1,I-1,
     ...
     +                              (WA3(I-2)*CC(M1,I,K,
     +                              4)-WA3(I-1)*CC(M1,I-1,K,4)))
                  CH(M2,I,3,K) = ((WA3(I-2)*CC(M1,I-1,K,
     +                           4)+WA3(I-1)*CC(M1,I,K,4))-
     +                           (WA1(I-2)*CC(M1,I-1,K,
     +                           2)+WA1(I-1)*CC(M1,I,K,2))) +
     +                           (CC(M1,I,K,1)- (WA2(I-2)*CC(M1,I,K,
     +                           3)-WA2(I-1)*CC(M1,I-1,K,3)))
                  CH(M2,IC,2,K) = ((WA3(I-2)*CC(M1,I-1,K,
     +                            4)+WA3(I-1)*CC(M1,I,K,4))-
     +                            (WA1(I-2)*CC(M1,I-1,K,
     +                            2)+WA1(I-1)*CC(M1,I,K,2))) -
     +                            (CC(M1,I,K,1)- (WA2(I-2)*CC(M1,I,K,
