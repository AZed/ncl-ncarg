...
C
C   $Id: mradb4.f,v 1.2 2006/11/21 01:10:17 haley Exp $
C
CCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCC

      SUBROUTINE DMRADB4(M,IDO,L1,CC,IM1,IN1,CH,IM2,IN2,WA1,WA2,WA3)
...
C
 ...
 1001     CONTINUE
  ...
  102 IDP2 = IDO + 2
     ...
     +                             ((CC(M1,I-1,1,K)-CC(M1,IC-1,4,K))-
     +                             (CC(M1,I,3,K)+CC(M1,IC,2,K))) -
     +                             WA1(I-1)* ((CC(M1,I,1,K)+CC(M1,IC,4,
     +                             K))+ (CC(M1,I-1,3,K)-CC(M1,IC-1,2,
     +                             K)))
                  CH(M2,I,K,2) = WA1(I-2)* ((CC(M1,I,1,K)+CC(M1,IC,4,
     +                           K))+ (CC(M1,I-1,3,K)-CC(M1,IC-1,2,K)))
     +                           + WA1(I-1)* ((CC(M1,I-1,1,K)-CC(M1,
     +                           IC-1,4,K))- (CC(M1,I,3,K)+CC(M1,IC,2,
     +                           K)))
                  CH(M2,I-1,K,3) = WA2(I-2)*
     +                             ((CC(M1,I-1,1,K)+CC(M1,IC-1,4,K))-
     +                             (CC(M1,I-1,3,K)+CC(M1,IC-1,2,K))) -
     +                             WA2(I-1)* ((CC(M1,I,1,K)-CC(M1,IC,4,
     +                             K))- (CC(M1,I,3,K)-CC(M1,IC,2,K)))
                  CH(M2,I,K,3) = WA2(I-2)* ((CC(M1,I,1,K)-CC(M1,IC,4,
     +                           K))- (CC(M1,I,3,K)-CC(M1,IC,2,K))) +
     +                           WA2(I-1)* ((CC(M1,I-1,1,K)+CC(M1,IC-1,
     +                           4,K))- (CC(M1,I-1,3,K)+CC(M1,IC-1,2,
     +                           K)))
                  CH(M2,I-1,K,4) = WA3(I-2)*
     +                             ((CC(M1,I-1,1,K)-CC(M1,IC-1,4,K))+
     +                             (CC(M1,I,3,K)+CC(M1,IC,2,K))) -
     +                             WA3(I-1)* ((CC(M1,I,1,K)+CC(M1,IC,4,
     +                             K))- (CC(M1,I-1,3,K)-CC(M1,IC-1,2,
     +                             K)))
                  CH(M2,I,K,4) = WA3(I-2)* ((CC(M1,I,1,K)+CC(M1,IC,4,
     +                           K))- (CC(M1,I-1,3,K)-CC(M1,IC-1,2,K)))
     +                           + WA3(I-1)* ((CC(M1,I-1,1,K)-CC(M1,
     +                           IC-1,4,K))+ (CC(M1,I,3,K)+CC(M1,IC,2,
     +                           K)))
 1002         CONTINUE
  103     CONTINUE
