...
C
C   $Id: r1fgkb.f,v 1.2 2006/11/21 01:10:19 haley Exp $
C
CCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCC

      SUBROUTINE DR1FGKB(IDO,IP,L1,IDL1,CC,C1,C2,IN1,CH,CH2,IN2,WA)
      ...
      DOUBLE PRECISION CH(IN2,IDO,L1,IP),CC(IN1,IDO,IP,L1),
     +                 C1(IN1,IDO,L1,IP),C2(IN1,IDL1,IP),
     +                 CH2(IN2,IDL1,IP),WA(IDO)
C
      TPI = 2.D0*4.D0*ATAN(1.0D0)
      ARG = TPI/DBLE(IP)
      DCP = COS(ARG)
      DSP = SIN(ARG)
      IDP2 = IDO + 2
      ...
      DO 111 J = 2,IPPH
          ...
          DO 110 K = 1,L1
              DO 109 I = 3,IDO,2
                  ...
                  CH(1,I-1,K,JC) = CC(1,I-1,2*J-1,K) -
     +                             CC(1,IC-1,2*J-2,K)
  ...
  135 CONTINUE
      ...
      DO 138 J = 2,IP
          ...
          DO 137 I = 3,IDO,2
              IDIJ = IDIJ + 2
              DO 136 K = 1,L1
                  C1(1,I-1,K,J) = WA(IDIJ-1)*CH(1,I-1,K,J) -
     +                            WA(IDIJ)*CH(1,I,K,J)
                  C1(1,I,K,J) = WA(IDIJ-1)*CH(1,I,K,J) +
