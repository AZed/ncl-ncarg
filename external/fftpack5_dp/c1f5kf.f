...
C
C   $Id: c1f5kf.f,v 1.2 2006/11/21 01:10:15 haley Exp $
C
CCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCC

      SUBROUTINE DC1F5KF(IDO,L1,NA,CC,IN1,CH,IN2,WA)
      ...
      DOUBLE PRECISION CC(IN1,L1,IDO,5),CH(IN2,L1,5,IDO),WA(IDO,4,2)
