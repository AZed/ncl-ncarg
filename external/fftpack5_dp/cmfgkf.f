...
C
C   $Id: cmfgkf.f,v 1.2 2006/11/21 01:10:16 haley Exp $
C
CCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCC

      SUBROUTINE DCMFGKF(LOT,IDO,IP,L1,LID,NA,CC,CC1,IM1,IN1,CH,CH1,
     +                   IM2,IN2,WA)
      ...
      DOUBLE PRECISION CH(2,IN2,L1,IDO,IP),CC(2,IN1,L1,IP,IDO),
  ...
  118 CONTINUE
      DO 116 L = 2,IPPH
          ...
          DO 113 KI = 1,LID
              ...
              DO 113 M1 = 1,M1D,IM1
                  M2 = M2 + IM2
                  CC1(1,M1,KI,L) = CH1(1,M2,KI,1) +
     +                             WA(1,L-1,1)*CH1(1,M2,KI,2)
                  CC1(1,M1,KI,LC) = -WA(1,L-1,2)*CH1(1,M2,KI,IP)
                  CC1(2,M1,KI,L) = CH1(2,M2,KI,1) +
     +                             WA(1,L-1,1)*CH1(2,M2,KI,2)
  ...
  113     CONTINUE
          DO 115 J = 3,IPPH
              ...
              DO 114 KI = 1,LID
                  ...
                  DO 114 M1 = 1,M1D,IM1
                      M2 = M2 + IM2
                      CC1(1,M1,KI,L) = CC1(1,M1,KI,L) +
     +                                 WAR*CH1(1,M2,KI,J)
                      CC1(1,M1,KI,LC) = CC1(1,M1,KI,LC) +
     +                                  WAI*CH1(1,M2,KI,JC)
                      CC1(2,M1,KI,L) = CC1(2,M1,KI,L) +
     +                                 WAR*CH1(2,M2,KI,J)
                      CC1(2,M1,KI,LC) = CC1(2,M1,KI,LC) +
     +                                  WAI*CH1(2,M2,KI,JC)
  114         CONTINUE
  115     CONTINUE
  116 CONTINUE
