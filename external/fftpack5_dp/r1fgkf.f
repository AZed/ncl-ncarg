...
C
C   $Id: r1fgkf.f,v 1.2 2006/11/21 01:10:19 haley Exp $
C
CCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCC

      SUBROUTINE DR1FGKF(IDO,IP,L1,IDL1,CC,C1,C2,IN1,CH,CH2,IN2,WA)
  ...
  103 CONTINUE
      ...
      DO 106 J = 2,IP
          ...
          DO 105 I = 3,IDO,2
              IDIJ = IDIJ + 2
              DO 104 K = 1,L1
                  CH(1,I-1,K,J) = WA(IDIJ-1)*C1(1,I-1,K,J) +
     +                            WA(IDIJ)*C1(1,I,K,J)
                  CH(1,I,K,J) = WA(IDIJ-1)*C1(1,I,K,J) -
     +                          WA(IDIJ)*C1(1,I-1,K,J)
  104         CONTINUE
  105     CONTINUE
  106 CONTINUE
      GO TO 111
