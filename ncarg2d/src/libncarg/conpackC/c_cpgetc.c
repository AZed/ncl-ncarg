/*
 *	$Id: c_cpgetc.c,v 1.6 2008/07/23 16:16:42 haley Exp $
 */
/************************************************************************
*                                                                       *
*                Copyright (C)  2000                                    *
...
extern void NGCALLF(cpgetc,CPGETC)(NGstring,NGstring,int,int);
 ...
 */
    if( !whch ) {
        fprintf( stderr, "c_cpgetc:  illegal parameter name (NULL)\n" );
        return;
    }
