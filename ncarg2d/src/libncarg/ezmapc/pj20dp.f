C
C $Id: pj20dp.f,v 1.5 2008/07/27 00:17:11 haley Exp $
C
C                Copyright (C)  2000
...
C
      SUBROUTINE PJ20DP (COORD,CRDIO,INDIC)
C
...
C ********************** X0,Y0,GAMMA,LON0,AL,BL,EL *********************
      ...
      SAVE   /PRINZ0/
      COMMON /PC20DP/ LON0,X0,Y0,AL,BL,COSALF,COSGAM,E,EL,SINALF,
     +                SINGAM,U0
