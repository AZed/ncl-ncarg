C
C $Id: pj11sp.f,v 1.5 2008/07/27 00:17:11 haley Exp $
C
C                Copyright (C)  2000
...
C
      SUBROUTINE PJ11SP (COORD,CRDIO,INDIC)
C
...
C **** PARAMETERS **** A,LON0,LAT0,X0,Y0,SINPH0,COSPH0 *****************
      ...
      SAVE   /PRINZ0/
      COMMON /PC11SP/ A,LON0,X0,Y0,COSPH0,LAT0,SINPH0
...
C
 ...
 2030    FORMAT (/' ERROR PJ11SP'/
     .            ' INPUT DATA ERROR')
         IERR = 115
         RETURN
  230    Z = TWO * ASINSP (CON)
         SINZ = SIN (Z)
         COSZ = COS (Z)
         GEOG(1) = LON0
