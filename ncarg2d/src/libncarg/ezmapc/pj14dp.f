C
C $Id: pj14dp.f,v 1.5 2008/07/27 00:17:11 haley Exp $
C
C                Copyright (C)  2000
...
C
      SUBROUTINE PJ14DP (COORD,CRDIO,INDIC)
C
...
C **** PARAMETERS **** A,LON0,LAT0,X0,Y0,SINPH0,COSPH0 *****************
      ...
      SAVE   /PRINZ0/
      COMMON /PC14DP/ A,LON0,X0,Y0,COSPH0,LAT0,SINPH0
