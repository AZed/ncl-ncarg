C
C $Id: pj12sp.f,v 1.5 2008/07/27 00:17:11 haley Exp $
C
C                Copyright (C)  2000
...
C
      SUBROUTINE PJ12SP (COORD,CRDIO,INDIC)
C
...
C **** PARAMETERS **** A,LON0,LAT0,X0,Y0,SINPH0,COSPH0 *****************
      ...
      SAVE   /PRINZ0/
      COMMON /PC12SP/ A,LON0,X0,Y0,COSPH0,LAT0,SINPH0
