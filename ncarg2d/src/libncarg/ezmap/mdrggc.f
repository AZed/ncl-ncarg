C
C $Id: mdrggc.f,v 1.9 2008/09/18 00:42:18 kennison Exp $
C
C                Copyright (C)  2000
...
C
      SUBROUTINE MDRGGC (JCOL,JCSF)
C
C This routine may be called to get the values of two arrays in EZMAP,
...
C
        IF (ICFELL('MDRGGC - UNCLEARED PRIOR ERROR',1).NE.0) RETURN
C
C Transfer contents of color-index internal arrays to argument arrays.
C
        DO 101 I=1,5
          JCOL(I)=ICOL(I)
          JCSF(I)=ICSF(I)
