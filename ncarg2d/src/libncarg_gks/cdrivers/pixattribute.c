/*
 *      $Id: pixattribute.c,v 1.2 2008/07/23 17:28:01 haley Exp $
 */
/************************************************************************
*                                                                       *
*                Copyright (C)  2000                                    *
 ...
 *                      attribute functions for the pix device driver
 */
#include <stdio.h>
#include <stdlib.h>
#include <X11/Xlib.h>
...
int
PIX_SetCharacterExpansionFactor
#ifdef  NeedFuncProto
(
        GKSC    *gksc
)
...
int
PIX_SetCharacterHeightAndUpVector
#ifdef  NeedFuncProto
(
        GKSC    *gksc
)
...
#endif
{
        ...
        if(xi->alloc_color){
                ...
                return PIX_SetColorRepresentation(gksc);
        }
        else{
                /*
